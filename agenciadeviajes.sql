...
INSERT INTO `testimoniales` (`id`, `nombre`, `correo`, `mensaje`) VALUES
	...
	(2, 'Fernando', 'soco@gmail.com', 'Nulla facilisi. Phasellus quis condimentum felis. Donec sit amet maximus ligula. Nulla id sem vitae neque mattis cursus ut sit amet nulla. Proin a risus nec enim maximus porttitor. Praesent eleifend risus ante, a lobortis lorem ultricies pretium.'),
	(3, 'Karla', 'ejemplo@hotmail.com', 'Nullam pharetra nisi faucibus metus aliquam sollicitudin. Praesent luctus sem vel lacinia pulvinar. Mauris imperdiet nulla vel vehicula feugiat. Fusce aliquam in lectus ac ullamcorper.'),
	(4, 'Karla', 'oscarsk69@gmail.com', 'Al contrario del pensamiento popular, el texto de Lorem Ipsum no es simplemente texto aleatorio. Tiene sus raices en una pieza cl´sica de la literatura del Latin, que data del año 45 antes de Cristo, haciendo que este adquiera mas de 2000 años de antiguedad. Richard McClintock, un profesor de Latin de la Universidad de Hampden-Sydney en Virginia, encontró una de las palabras más oscuras de la lengua del latín'),
